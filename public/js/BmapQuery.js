        ...
        _createClass(Bmap, [
            ...
            },
            {
                ...
                value: function (e, t, o) {
                    ...
                    if ("" == this.map || "" == e || "" == t || "" == o)
                        return !1;
                    (i = void 0 !== arguments[3] && 0 != arguments[3]),
                        (a = void 0 !== arguments[4] && 0 != arguments[4]),
                        (n = void 0 !== arguments[5] && 0 != arguments[5]),
                        (s = void 0 === arguments[6] || 1 == arguments[6]);
            ...
            },
            {
                ...
                value: function () {
                    for (
                        var e = this.map, t = e.entities.getLength() - 1;
                        t >= 0;
                        t--
                    ) {
                        _instanceof(
            ...
            },
            {
                ...
                value: function (e, t) {
                    var o = this.map,
                        ...
                        a = [],
                        n = [];
                    if ("" == o || "object" !== _typeof(e) || 0 === e.length)
                        return !1;
                    for (
                        var s = function (s) {
                                var r = new Microsoft.Maps.Location(
                                    e[s].lat,
                                    e[s].lon
                                );
                                (i[s] = new Microsoft.Maps.Layer()),
                                    (i[s].metadata = {
                                    ...
                                    i[s].add(a[s]),
                                    (n[s] = new Microsoft.Maps.Infobox(r, {
                ...
                value: function (e, t, o, i, a, n) {
                    ...
                    (s.onload = function () {
                        ...
                        (t.width = s.width * o),
                            ...
                            t
                                .getContext("2d")
                                .drawImage(s, 0, 0, t.width, t.height);
            ...
            },
            {
                key: "crearInfobox",
                value: function () {
                    for (var e = this.infoboxs.length, t = 0; t < e; t++)
                        this.infoboxs[t].setOptions({ visible: !1 }),
            ...
            },
            {
                ...
                value: function (e, t, o, i, a, n) {
                    ...
                    (this.infoboxs[s] = new Microsoft.Maps.Infobox(
                        this.setLocation(e, t),
                        { maxHeight: o, maxWidth: i, title: a, description: n }
                    )),
                ...
                value: function (e, t) {
                    ...
                    return new Promise(function (t) {
                        ...
                        Microsoft.Maps.loadModule(
                            ...
                            function () {
                                (i = new Microsoft.Maps.Search.SearchManager(
                                    o
                                )) &&
                                    i.geocode({
                                        where: e,
                        ...
                        return (
                            !0 === t && o.setView({ bounds: e.bestView }),
                            e.location
                        );
                    });
                },
                    ...
                    return new Promise(function (o) {
                        ...
                        if (!i) {
                            ...
                            Microsoft.Maps.loadModule(
                                ...
                                function () {
                                    (i =
                                        new Microsoft.Maps.Search.SearchManager(
                                            t
                                        )).reverseGeocode(a);
                                }
                            );
                ...
                value: function (e, t, o, i) {
                    ...
                    Microsoft.Maps.loadModule(
                        ...
                        function () {
                            ...
                            a.addWaypoint(c),
                                a.setRenderOptions({ itineraryContainer: e }),
                                Microsoft.Maps.Events.addHandler(
                                    a,
                                    "directionsError",
                                    function (e) {
                                ...
                                Microsoft.Maps.Events.addHandler(
                                    ...
                                    function (e) {
                                        var t =
                                            a.getRequestOptions().routeIndex;
                                        Math.round(
                                            100 * e.routeSummary[t].distance
                                        );
                                        a.getRequestOptions().distanceUnit,
                                            Microsoft.Maps.Directions
                                                .DistanceUnit.km;
                                    }
                                ),
                    ...
                    Microsoft.Maps.loadModule(
                        ...
                        function () {
                            new Microsoft.Maps.AutosuggestManager({
                                ...
                                o.entities.clear(),
                                    o.entities.push(
                                        new Microsoft.Maps.Pushpin(e.location)
                                    ),
                        ...
                        function () {
                            Microsoft.Maps.SpatialDataService.GeoDataAPIManager.getBoundary(
                                ...
                                function (e) {
                                    e.results &&
                                        e.results.length > 0 &&
                                        t.entities.push(e.results[0].Polygons);
                                },
                                null,
                                function (e, t) {
                ...
                value: function (e) {
                    ...
                    t.entities.push(a),
                        (this.watchId = navigator.geolocation.watchPosition(
                            function (n) {
                                var s = new Microsoft.Maps.Location(
                                    n.coords.latitude,
                                    n.coords.longitude
                                );
                                a.setLocation(s),
                                    a.setOptions({ visible: !0 }),
                                    t.setView({ center: s }),
                                    !0 === e && console.log(s),
                                    o.push(s),
                                    i.push(
                    ...
                    void 0 !== arguments[2] &&
                        ...
                        0 === c &&
                            navigator.geolocation.getCurrentPosition(function (
                                ...
                                var t = new Microsoft.Maps.Location(
                                    e.coords.latitude,
                                    e.coords.longitude
                                );
                        ...
                        (this.watchId = navigator.geolocation.watchPosition(
                            function (l) {
                                var u = new Microsoft.Maps.Location(
                                    l.coords.latitude,
                                    l.coords.longitude
                                );
                                o.setLocation(u),
                                ...
                                n.push(p);
                                var f = { strokeColor: e, strokeThickness: t };
                                i.entities.push(
                                    new Microsoft.Maps.Polyline(a, f)
                                ),
                                    1 == s && (console.log(a), console.log(n)),
                                    "" != r &&
                                        null != p &&
            ...
            },
            {
                ...
                value: function (e, t, o) {
                    ...
                    function s() {
                        for (
                            var e, t = i.getZoom(), o = 0;
                            o < i.layers.length;
                            o++
                        )
                            (e = i.layers[o]).metadata &&
                                e.metadata.zoomRange &&
                                (t >= e.metadata.zoomRange.min &&
                                t <= e.metadata.zoomRange.max
                                    ? e.setVisible(!0)
                                    : e.setVisible(!1));
                    }
                    Microsoft.Maps.loadModule(
                        ...
                        function () {
                            for (
                                var s = new Microsoft.Maps.Search.SearchManager(
                                        i
                                    ),
                                    r = 0;
                                r < e.length;
                        ...
                        Microsoft.Maps.Events.addHandler(i, "viewchangeend", s),
                        s();
                },
            },
            {
                ...
                value: function (e) {
                    var t = this.map;
                    Microsoft.Maps.loadModule(
                        ["Microsoft.Maps.GeoJson", "Microsoft.Maps.HeatMap"],
                        function () {
