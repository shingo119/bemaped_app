...
class SpotController extends Controller
{
    ...
    function link_title($text){ 
        ...
        $patterns[4] = '/五一わいんバナー/';
        $replacements = array();
        $replacements[4] = `<a href="https://www.furusato-tax.jp/product/detail/20215/4987992" onClick="ga('send', 'event', 'views/view.blade.php', 'https://www.furusato-tax.jp/product/detail/20215/4987992', 'banner_4');" target="_blank"><div class="flex justify-center w-full border-b bn-color"><img src="https://www.furusato-tax.jp/img/agreement/728_90.png" alt="ふるさとチョイス" width="728" height="90" decoding="async" /></div></a>`;
        $replacements[3] = `<a href="https://www.furusato-tax.jp/product/detail/20215/5029417" onClick="ga('send', 'event', 'views/view.blade.php', 'https://www.furusato-tax.jp/product/detail/20215/5029417', 'banner_5');" target="_blank"><div class="flex justify-center w-full border-b bn-color"><img src="https://www.furusato-tax.jp/img/agreement/728_90.png" alt="ふるさとチョイス" width="728" height="90" decoding="async" /></div></a>`;
