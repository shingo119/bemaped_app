...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-227736458-1"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-227736458-1');
        </script>
        <!-- Google Tag Manager -->
        ...
        })(window,document,'script','dataLayer','GTM-TTB2563');</script>
    ...
    <body class="flex justify-start">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TTB2563"
