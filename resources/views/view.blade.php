...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div id="#hidden_veiw" class="w-full h-full overflow-y-hidden flex justify-center">
            <div class="bg-gray-200 absolute top-12 w-full h-full rounded-3xl max-w-5xl">
                ...
                <div class="w-full h-full  flex justify-center">
                    <div class="view_container bg-yellow-300 rounded-3xl w-11/12 h-2/5 mt-2 ss:h-3/5 max-w-4xl">
                    @foreach($spots as $spot)
                        <div class="view_content_wrap w-11/12 h-full mx-auto">
                            ...
                            <div class="icons  flex items-center mt-1">
