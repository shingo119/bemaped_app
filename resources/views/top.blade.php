            ...
            function GetMap() {
                ...
                const mappingFunction = (datas) => {
                    datas.forEach((el,i) => {
                        ...
                        console.log(ytimg)
                        // console.log(icon)
                        map.infoboxHtml(lat, lon,`<div id="pin_id${el['spot_id']}" class="relative -left-12 -top-[110px]"><img class="w-24" src="{{asset("img/pin.png")}}"><img class="absolute left-2 top-2 w-10 rounded-full" src="{{ asset('storage/${icon}') }}"></div>`);
