            ...
            function GetMap() {
                ...
                const mappingFunction = (datas) => {
                    datas.forEach((el,i) => {
                        ...
                        map.infoboxHtml(lat, lon,'<div id="pin_id'+el['spot_id']+'" class="relative -left-12 -top-28"><img class="w-24" src="{{asset("img/pin.png")}}"><img class="absolute left-2 top-2 w-20 rounded-full" src="http://home/bemaped/bemaped_app/storage/'+ el['icon_img'] +'"></div>');
