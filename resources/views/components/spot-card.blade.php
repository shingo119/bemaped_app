    ...
    <div class="spot_card_element_wrap snap-center w-full h-full p-2 flex items-center box-border min-w-full select-none" >
        @csrf
        <button type="submit" class="cursor w-full h-full z-index">
            <div id="{{$spot->spot_id}}" class="view_button w-full h-full py-2 hover:text-white hover:font-bold bg-aaa hover:bg-blue-400 ring-4 ring-white rounded-xl box-border flex items-center h-40 justify-between">
