    ...
    <body>
        ...
        <div class="w-full h-full overflow-y-hidden flex justify-center">
            <div class="bg-gray-200 absolute top-12 w-full h-full rounded-3xl max-w-5xl">
                <a href="{{route('mapping_map')}}"><img class="w-12 h-12 mt-3 ml-8" src="{{asset('img/back_button.png')}}" alt=""></a>
                <div class="w-full h-full  flex justify-center">
                    <div class="view_container bg-yellow-300 rounded-3xl w-11/12 h-3/5 mt-2 max-w-4xl sm:h-4/5">
                        <form id="spot" action="{{route('store')}}" method="POST">
                            @csrf
                            <div class="input_item flex flex-col justify-around" data-wow-delay=".5s">
                                <!-- Name -->
                                <input type="text" name="movie_title" required="required" class="rounded-lg h-8 p-2 mx-8 my-3 sm:h-12" placeholder="動画タイトル（必須）" />
                                <!-- Email -->
                                <input type="text" name="movie_url" required="required" class="rounded-lg h-8 p-2 mx-8 my-3 sm:h-12" placeholder="動画URL（必須）" />
                                <!-- コメント -->
                                <textarea type="text" name="comment" class="rounded-lg h-20 p-2 mx-8 my-3 sm:h-80" placeholder="説明"></textarea>
                                <!-- Subject -->
                                <input type="text" name="tag" class="rounded-lg h-8 p-2 mx-8 my-3 sm:h-12" placeholder="＃タグ" />
                                <select class="rounded-lg h-8 p-1 mx-8 my-3 sm:h-12 text-gray-500" name="category_id" form="spot">
                                    <option hidden>カテゴリを選択（必須）</option>
                            ...
                            <div class="flex justify-center">
                                <!-- Send Button -->
                                <button type="submit" class="p-2 rounded-xl text-white bg-red-500 drop-shadow-lg">動画をマッピング</button>
        ...
        <script>
            ...
            const getjson = localStorage.getItem('str');
